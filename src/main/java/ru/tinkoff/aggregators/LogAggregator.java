package ru.tinkoff.aggregators;

import ru.tinkoff.logs.LogParser;
import ru.tinkoff.logs.LogRecord;
...
public class LogAggregator {
    ...
    /**
     * Download file with given url and save a result to temp file
     *
     * @param url - url of file to download
     * @return Path of downloadedTempFile
     */
    private Path downloadFile(URL url) throws IOException {
        // Create an input channel from url and out channel to file in local directory
